...
public final class IppEncoder {
    ...
    public static byte[] printJobHeader(String printerUri, String user, String jobName) throws Exception {
        ...
        d.writeByte(0x02); d.writeByte(0x00); d.writeShort(0x0002); d.writeInt((int)(System.currentTimeMillis() & 0x7fffffff));
        d.writeByte(0x01);
        ...
        d.writeByte(0x03); d.flush(); return out.toByteArray();
    }
}
